...
FILES=(
  ...
  # in the legacy and hyperpipeline formats; 6 tests, 9 s, subprocesses only.
...
#   386/374  + test_cleanile_intrinsic_precision.py (6 tests: --clean-ile-intrinsic-digits
...
#            2026-09-14, IGWN conda python 3.11 / numpy 1.26.4 / lal 7.7.0: per-file 386 over
#            40 files, junit 389 / 12 skipped / 377 passed.  389 and 377 are the counts WITH
#            pytest-subtests, which that environment happens to have; the floors below stay
#            pinned to the plugin-free 386/374 for the reason given above.
#
