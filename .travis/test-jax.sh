...
# (superseded by the measured value below) EXPECTED_TESTS=761
...
# ONE ASSIGNMENT ONLY.  Merging #312 with the multipeak branch left THREE live
# EXPECTED_TESTS= lines (761, 755, 762) on DIFFERENT lines, so git saw no conflict
# and bash silently took the last.  The binding value was right; the shape was the
# defect.  A later reorder changes the answer, and anyone editing 'the' assignment
# has two chances to edit a dead one.  If you add a rung here, edit THIS line.
EXPECTED_TESTS=762
