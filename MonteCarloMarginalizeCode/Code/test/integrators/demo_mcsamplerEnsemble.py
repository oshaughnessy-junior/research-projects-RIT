# Hand-run GMM-vs-mcsampler comparison demo, not a pytest target (hence demo_, not
# test_): it defines no test functions, runs entirely at import, and writes cdf.png
